...
/*------------------------------------------------------
	CPS1 Port 2 (Controller 3 / Additional Buttons)
------------------------------------------------------*/
...
/*------------------------------------------------------
	Adjust Input Buttons According to Screen Direction
------------------------------------------------------*/
