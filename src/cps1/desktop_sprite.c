/******************************************************************************
	...
	CPS1 Sprite Manager - Desktop (SDL) Platform
...
static struct Vertex ALIGN16_DATA vertices_object[OBJECT_MAX_SPRITES * 2];
...
static struct Vertex ALIGN16_DATA vertices_scrollh[SCROLLH_MAX_SPRITES * 2];
...
int blit_stars_init(int enabled)
{
	...
	vertices_stars = (struct PointVertex *)malloc(
