...
/*--------------------------------------------------------
	NEOGEO CDZ Emulation Initialization
--------------------------------------------------------*/
...
/*--------------------------------------------------------
	NEOGEO CDZ Emulation Execution
--------------------------------------------------------*/
...
/*--------------------------------------------------------
	NEOGEO CDZ Emulation Exit (called by BIOS)
--------------------------------------------------------*/
