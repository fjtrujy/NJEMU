...
static uint8_t ALIGN16_DATA neogeo_game_vectors[NEOGEO_VECTORS_SIZE];
...
/*------------------------------------------------------
	$200000 Memory Handler (no protection)
------------------------------------------------------*/
...
/*------------------------------------------------------
	...
	Not actually protection, but handled as protection
------------------------------------------------------*/
