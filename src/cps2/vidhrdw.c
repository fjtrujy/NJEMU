...
/*------------------------------------------------------
	Palette (objects only reflected with 1 frame delay)
------------------------------------------------------*/
